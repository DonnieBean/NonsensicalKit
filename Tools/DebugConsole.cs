...
namespace NonsensicalKit
{
    ...
    public class DebugConsole : MonoBehaviour
    {
        ...
        static readonly GUIContent logToFileLabel = new GUIContent("LogToFile", "Log contents to a txt file.");
        ...
        void DrawToolbar()
        {
            ...
            if (GUILayout.Button(logToFileLabel))
            {
                ...
                NonsensicalDebugger.LogToFile(sb.ToString());
            }
