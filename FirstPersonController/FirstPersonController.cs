...
namespace NonsensicalKit
{
    ...
    public class FirstPersonController : NonsensicalMono
    {
        ...
        private void Move()
        {
            ...
            float targetSpeed = _input.leftShiftKeyHold ? SprintSpeed : MoveSpeed;
        ...
        private void JumpAndGravity()
        {
            if (Grounded)
            {
                ...
                // Jump
                if (_input.spaceKeyEnter && _jumpTimeoutDelta <= 0.0f)
                {
